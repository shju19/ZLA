...
public class MainStoreActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTracker.setScreenName("main store screen");
        ...
        TextView adress1 = (TextView) findViewById(R.id.adress1); TextView adress2 = (TextView) findViewById(R.id.adress2);
        TextView contact1 = (TextView) findViewById(R.id.contact1); TextView contact2 = (TextView) findViewById(R.id.contact2);
        TextView brand1 = (TextView) findViewById(R.id.brand1); TextView brand2 = (TextView) findViewById(R.id.brand2);
        TextView fitting1 = (TextView) findViewById(R.id.fitting1); TextView fitting2 = (TextView) findViewById(R.id.fitting2);
        TextView repair1 = (TextView) findViewById(R.id.repair1); TextView repair2 = (TextView) findViewById(R.id.repair2);
        //영업시간 및 매장위치
        TextView businessHour = (TextView) findViewById(R.id.businessHour);
        TextView businessHour_weekly1 = (TextView) findViewById(R.id.businessHour_weekly1); TextView businessHour_weekly2 = (TextView) findViewById(R.id.businessHour_weekly2);
        TextView businessHour_saturday1 = (TextView) findViewById(R.id.businessHour_saturday1); TextView businessHour_saturday2 = (TextView) findViewById(R.id.businessHour_saturday2);
        TextView businessHour_holiday1 = (TextView) findViewById(R.id.businessHour_holiday1); TextView businessHour_holiday2 = (TextView) findViewById(R.id.businessHour_holiday2);
        TextView holiday1 = (TextView) findViewById(R.id.holiday1); TextView holiday2 = (TextView) findViewById(R.id.holiday2);
        ...
        adress1.setTypeface(face); adress2.setTypeface(face);
        contact1.setTypeface(face); contact2.setTypeface(face);
        brand1.setTypeface(face); brand2.setTypeface(face);
        fitting1.setTypeface(face); fitting2.setTypeface(face);
        repair1.setTypeface(face); repair2.setTypeface(face);
        businessHour.setTypeface(face);
        businessHour_weekly1.setTypeface(face); businessHour_weekly2.setTypeface(face);
        businessHour_saturday1.setTypeface(face); businessHour_saturday2.setTypeface(face);
        businessHour_holiday1.setTypeface(face); businessHour_holiday2.setTypeface(face);
        holiday1.setTypeface(face); holiday2.setTypeface(face);
        storeLocation.setTypeface(face);
        callStore.setTypeface(face);

        Intent intent = getIntent();                    //인텐트 얻기
        //매장정보
        final String getStoreName = intent.getStringExtra("storeName");    //ListActivity에서 데이터 받기
        final String getContact = intent.getStringExtra("contact");    //ListActivity에서 데이터 받기
        ...
        for (int i = 0; i < Length; i++) {
            ...
            if ((c.getString(3)).equals(getStoreName)) {
                if(c.getString(9).equals(getContact)) {
                    break;
                }
            }
            c.moveToNext();
        ...
        for(int i=0; i < 17; i++) {
            if(c.getString(17+i*2+series).equals("o")) { brandSelect += brand[i] + "  "; } else {  }
        }
        brandSelect += c.getString(54); //기타 브랜드 추가
        //취급 브랜드만 표기
        if(c.getString(11).equals("o")) { fitting += "일반피팅"; } if(c.getString(12).equals("o")) { fitting += " | 전문피팅"; }
        if(c.getString(13).equals("o")) { repair = "가능"; } else { repair = "불가능"; }
                        ...
                        ad.setTitle("전화").setMessage("즐라에서 보고 연락드렸다고 말씀하시면 문의가 빠릅니다").
                                setPositiveButton("전화하기", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        mTracker.send(new HitBuilders.EventBuilder().setCategory("main store screen: call button").setLabel("key").build());
                                        // 전화하기
